...
export const casts: Cast[] = [
  // ブランドロゴ（完全版）のカード。一覧の先頭（左上）に置く（DK 指定）。画像は scripts/make-logo-cast.py で生成する
  { id:7, name:"O-RA",  catch:"O-RA ～TOKYO～ へようこそ", profile:"お店のロゴの女の子です。", img:"/images/cast/cast-07.jpg" },
  { id:1, name:"あかね", catch:"笑顔と話術で場を彩ります", profile:"明るく話しやすい雰囲気が自慢。どんな話題にも対応できる引き出しの多さで、特別なひとときをお届けします。", img:"/images/cast/cast-01.jpg" },
  { id:2, name:"みこ",  catch:"上質な時間をともに", profile:"落ち着いた雰囲気で接待・会食のシーンを華やかに演出。大人の会話をお楽しみいただけます。", img:"/images/cast/cast-02.jpg" },
  { id:3, name:"れな",  catch:"あなたの夜をもっと輝かせたい", profile:"エネルギッシュな笑顔で場を盛り上げます。初めてご来店の方もすぐに打ち解けられると好評です。", img:"/images/cast/cast-03.jpg" },
